...
extern prod_command	  	amc_cmd_list[];
extern char				amc_cmd_no;
...
//main function for amc functions
int amc_main(int argc, char * const argv[])
{
	...
	printf("\n\r********************************************************");
        printf("\n\r********************************************************");
	printf("\n\r**     TDSDR - AMC Management Functions               **");
	printf("\n\r********************************************************");
	printf("\n\r********************************************************\r\n");
	//printf("\r\nEnter 'help' to see available commands. Enter 'stop' to return to the main menu.\r\n");
		...
		i=0;
	    while(i<amc_cmd_no){
			if(strcmp(argv[1],amc_cmd_list[i].name) == 0){
				printf("\r\n");
				//execute the command if it was found.
			    amc_cmd_list[i].function(arguments, argcount);
			    break;
			}
			i++;
		}
