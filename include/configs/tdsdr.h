/*
 * Configuration for the Silver Bullet Technologies TDSDR board, common
 * Adapted from Xilinx ZC70x configs
 *
 * (C) Copyright 2014 Silver Bullet Technologies
...
// TDSDR should use a 40MHz VCTCXO
...
#define CONFIG_SYS_PROMPT           "tdsdr-uboot> "
...
/* Ethernet driver from zynq_common */
