...
#define CONFIG_SYS_SDRAM_BASE		(DMC_S_ABSOLUTE_BASE)
...
# define CONFIG_PL011_CLOCK				(CONFIG_SYS_REF_CLK_HZ)
...
# define CONFIG_SYS_SPI_CLK		(CONFIG_SYS_REF_CLK_HZ)
